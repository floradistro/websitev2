...
const themes = {
  vendor: {
    ...
    components: {
      ...
      input:
        "w-full bg-black/20 border border-white/10 text-white px-4 py-3 focus:outline-none focus:border-white/30 transition-all rounded-[14px] text-sm",
      badge: {
      ...
      action:
        "group bg-white/[0.02] backdrop-filter backdrop-blur-[20px] border border-white/5 rounded-[14px] hover:bg-white/[0.03] p-6 transition-all duration-300 flex items-center gap-4",
    },
  },
  ...
  admin: {
    ...
    components: {
      ...
      action:
        "group bg-white/[0.02] backdrop-filter backdrop-blur-[20px] border border-white/5 rounded-[20px] hover:bg-white/[0.03] p-6 transition-all duration-300 flex items-center gap-4",
    },
  },
};
