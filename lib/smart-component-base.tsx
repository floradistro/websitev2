...
export const SmartTypography = {
  ...
  Subheadline: ({ children, className = '' }: { children: React.ReactNode; className?: string }) => (
  ...
  Body: ({ children, className = '' }: { children: React.ReactNode; className?: string }) => (
    <p className={`text-sm sm:text-base text-white/60 leading-relaxed ${className}`}>
      {children}
    </p>
  ),
...
export const SmartContainers = {
  ...
  Card: ({ children, className = '', hover = true }: { children: React.ReactNode; className?: string; hover?: boolean }) => (
    <div className={`bg-[#0a0a0a] border border-white/5 rounded-2xl ${hover ? 'hover:border-white/10' : ''} transition-all ${className}`}>
      {children}
    </div>
  ),
  
  Grid: ({ children, cols = 3, className = '' }: { children: React.ReactNode; cols?: number; className?: string }) => (
    <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-${cols} gap-4 sm:gap-6 ${className}`}>
      {children}
    </div>
  )
};
...
export function SmartButton({
  ...
  const baseStyles = 'inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 sm:py-4 rounded-2xl font-black uppercase tracking-[0.08em] text-xs sm:text-sm transition-all';
