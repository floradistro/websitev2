...
export const designSystem = {
  ...
  components: {
    ...
    iconContainer: 'bg-[#0a0a0a] rounded-3xl border border-white/[0.04] hover:border-white/[0.08] hover:bg-white/[0.06] transition-all duration-400 ease-out shadow-lg shadow-black/30',

    // Input field
    input: 'bg-white/[0.03] border border-white/[0.06] rounded-lg px-3 py-2 text-white text-sm placeholder:text-white/30 focus:border-white/[0.12] focus:bg-white/[0.04] outline-none transition-all duration-200',

    // Button primary
    button: 'bg-white/[0.06] hover:bg-white/[0.08] border border-white/[0.06] hover:border-white/[0.12] rounded-lg px-4 py-2 text-[10px] uppercase tracking-[0.15em] font-light text-white/70 hover:text-white/90 transition-all duration-300 ease-out',
