...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      RAISE NOTICE 'DEBUG: v_po_item.quantity = %, v_po_item.quantity_received = %, v_quantity_received = %',
        v_po_item.quantity, v_po_item.quantity_received, v_quantity_received;
      RAISE NOTICE 'DEBUG: Calculation: (% + %) > % = %',
        COALESCE(v_po_item.quantity_received, 0), v_quantity_received, v_po_item.quantity,
        (COALESCE(v_po_item.quantity_received, 0) + v_quantity_received) > v_po_item.quantity;
