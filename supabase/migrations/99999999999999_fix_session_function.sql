...
-- Issue: walk_in_sales column in pos_sessions is INTEGER but function returns NUMERIC
-- This migration ensures the function return type matches the table structure
