...
import { a } from "./chunk-MU6SADSF.js";
...
`,
  r = class r extends a$1 {
    constructor() {
      super();
      let o = this.attachShadow({ mode: "open" });
      ((o.innerHTML = n), o.append(r.createStyleElement().cloneNode(true)));
    }
    set haloGlow(o) {
      this.toggleAttribute("halo-glow", o);
    }
    get haloGlow() {
      return this.hasAttribute("halo-glow");
    }
    set backgroundColor(o) {
      this.style.setProperty("--background-color", `#${o.toJSON()}`);
    }
    get backgroundColor() {
      return n$1.fromHex(this.style.getPropertyValue("--background-color"));
    }
    set borderColor(o) {
      this.style.setProperty("--border-color", `#${o.toJSON()}`);
    }
    get borderColor() {
      return n$1.fromHex(this.style.getPropertyValue("--border-color"));
    }
    static create() {
