...
var e = n$1.fromRGBA(46, 193, 206, 1),
  ...
  B = n$1.fromRGBA(169, 237, 204, 1),
  f = n$1.fromRGBA(212, 246, 230, 1),
  s = n$1.fromRGBA(251, 192, 44, 1),
  x = n$1.fromRGBA(252, 205, 86, 1),
  y = n$1.fromRGBA(253, 217, 128, 1),
  A = n$1.fromRGBA(254, 230, 171, 1),
  d = n$1.fromRGBA(254, 242, 213, 1),
  S = n$1.fromRGBA(250, 68, 70, 1),
  l = n$1.fromRGBA(251, 105, 107, 1),
  g = n$1.fromRGBA(252, 143, 144, 1),
  i = n$1.fromRGBA(253, 180, 181, 1),
  O = n$1.fromRGBA(254, 218, 218, 1),
  T = n$1.fromRGBA(10, 51, 144, 1),
  u = n$1.fromRGBA(22, 96, 217, 1),
  C = n$1.fromRGBA(217, 231, 255, 1);
export {
  e as a,
  n as b,
  t as c,
