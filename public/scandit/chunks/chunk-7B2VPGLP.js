...
void main() {
  ...
  x = class extends a {
    ...
    readFromSource(t) {
      var _, h;
      (this.updateCanvasSizeIfNeeded(), this.updateFrameSizeIfNeeded());
      let e =
          (_ = t == null ? void 0 : t.videoWidth) != null
            ? _
            : this._contextWebGL.drawingBufferWidth,
        {
          drawingBufferWidth: r,
      ...
      (this._webglContext.uniform1f(p, u),
        ...
        this._webglContext.drawArrays(d, 0, 6));
      let a = (h = this._framePool) == null ? void 0 : h.pop();
      if (!a) throw new Error("Frame pool found empty!");
      this._webglContext.readPixels(0, 0, r, i, o, s, a);
      let b = new Uint8ClampedArray(a.buffer, 0, e * i);
      return { width: e, height: i, data: b, colorType: "GRAYSCALE" };
    }
    setup() {
      (this.initShaderProgram(), this.initBuffers(), this.initTexture());
    }
    dispose() {
      var t;
      (this._shaderProgram &&
    ...
    updateCanvasSizeIfNeeded() {
      this._canvas &&
        (this._canvas.width !== this._contextWebGL.drawingBufferWidth / 4 ||
          this._canvas.height !== this._contextWebGL.drawingBufferHeight) &&
        ((this._canvas.width = this._contextWebGL.drawingBufferWidth / 4),
        (this._canvas.height = this._contextWebGL.drawingBufferHeight));
    }
    updateFrameSizeIfNeeded() {
      ...
      this._frameSize !== r &&
        ...
        (i = this._framePool) == null || i.empty(),
        (this._framePool = new a$1({
    ...
    initShaderProgram() {
      let t = b(this._webglContext, this._webglContext.VERTEX_SHADER, m),
        e = b(this._webglContext, this._webglContext.FRAGMENT_SHADER, w);
      if (!t || !e) throw new Error("Shaders cannot be created");
      ((this._shaderProgram = a$2(this._webglContext, t, e)),
        this._webglContext.useProgram(this._shaderProgram));
    }
    initBuffers() {
    ...
    initTexture() {
      ((this._texture = this._webglContext.createTexture()),
        ...
        this._webglContext.texParameteri(
          ...
          this._webglContext.CLAMP_TO_EDGE,
        ),
        this._webglContext.texParameteri(
          this._webglContext.TEXTURE_2D,
          this._webglContext.TEXTURE_WRAP_T,
          this._webglContext.CLAMP_TO_EDGE,
        ),
        this._webglContext.texParameteri(
          this._webglContext.TEXTURE_2D,
          this._webglContext.TEXTURE_MIN_FILTER,
