...
var s = class i {
  ...
  static async fromImage(e) {
    ...
    try {
      ...
      throw new a({
        name: "InvalidImageError",
        message: "Submitted image cannot be decoded",
      });
    }
    let r = t.getCanvasAndContext(e.width, e.height);
    return (
      r.drawImage(e, 0, 0),
      (t._imageData = r.getImageData(0, 0, e.width, e.height, {
        colorSpace: "srgb",
      })),
      t
    );
  }
  static async fromImageData(e) {
    let t = new i(),
      r = t.getCanvasAndContext(e.width, e.height);
    try {
      r.putImageData(e, 0, 0);
    } catch (a$1) {
      throw new a({
        name: "InvalidImageError",
        message: `Submitted image data does not seem valid (details: ${a$1})`,
      });
    }
    return ((t._imageData = e), t);
  }
  async switchToDesiredState(e) {
    if (e === "on") {
      if (this.currentState === "on") return;
    } else if (this.currentState === "off") return;
    return (
      (this._desiredState = e),
      this._imageData == null
        ? (a$1.log(a$1.Level.Warn, "No image data to process."),
          this.processSubmittedImage({
            data: new Uint8ClampedArray(0),
            width: 0,
            height: 0,
            colorSpace: "srgb",
          }))
        : this.processSubmittedImage(this._imageData)
    );
  }
  addListener(e) {
    e != null && this._listeners.add(e);
  }
  removeListener(e) {
    e != null && this._listeners.delete(e);
  }
  toJSONObject() {
  ...
  getCanvasAndContext(e, t) {
    let r = document.createElement("canvas");
    ((r.width = e), (r.height = t));
    let a$1 = r.getContext("2d");
    if (a$1 == null)
      throw new a({
        name: "ImageFrameSourceError",
        message: "Could not generate a canvas context to get image data",
      });
    return a$1;
  }
