import { a as a$6, b } from "./chunk-LISC6VSM.js";
import { a as a$a } from "./chunk-BA3RP6L2.js";
import { a as a$2 } from "./chunk-34HLD6AY.js";
import { a as a$5 } from "./chunk-JS3T7K2Z.js";
import { a as a$3 } from "./chunk-NKCR7VPO.js";
import { a as a$4 } from "./chunk-7SW2PEHB.js";
import { a as a$7 } from "./chunk-FGO2SSRS.js";
import { d } from "./chunk-4XTOUXDD.js";
import { a as a$1 } from "./chunk-UCD6YLP3.js";
import { a as a$8 } from "./chunk-XR65N6EG.js";
import { f } from "./chunk-7ELPJFJV.js";
import { a as a$9 } from "./chunk-WUHKODFA.js";
import { c } from "./chunk-TR3NGINC.js";
function n(l, e, t) {
  let r = t.value;
  return (
    (t.value = function (...s) {
...
function g(l) {
  return "skipSerialization" in l || l[a$a] != null;
}
var N,
  E,
  R,
  a = class a {
    constructor() {
      ...
      this.pendingWorkerMessageListeners = new Set();
          ...
          (b =
            (S = (y = e.dataCaptureInstance) == null ? void 0 : y.highEndBlurryRecognition) != null
              ...
              : (w = t.mainDataCaptureLoader) == null
                ? void 0
                : w.highEndBlurryRecognition) != null
            ? b
            : false));
      for (let I of this.pendingWorkerMessageListeners)
        this.dataCaptureInstance.addWorkerListener(I);
      (this.pendingWorkerMessageListeners.clear(),
        this.settings != null && (await this.applySettings(this.settings)),
    ...
    static async createWithOptions(e) {
      return (
        a._sharedInstance && (await a._sharedInstance.dispose()),
        await a.sharedInstance.initializeWithOptions(e),
        a.sharedInstance
      );
    }
    static async getOpenSourceSoftwareLicenseInfo() {
      let e = [];
      for (let r of a.moduleLicenseTextProviders) {
        let s = await r.getLicenseText();
        e.push(s);
      }
      let t = e.join(`
...
`);
    ...
    async setFrameSource(e) {
      ...
      if (
        (this._frameSource !== null && (this._frameSource.context = null),
        (this._frameSource = e != null ? e : null),
        e &&
          ((e.context = this),
          await this.workerCommand("setFrameSource", {
    ...
    async addMode(e) {
      (this.modes.add(e),
        await e.attachedToContext(this),
        this.updateCameraFrameFlow(),
        await this.update([], { updateContext: !g(e) }));
    }
    async removeMode(e) {
      (this.modes.delete(e),
        await e.detachedFromContext(),
        this.updateCameraFrameFlow(),
        await this.update([], { updateContext: !g(e) }));
    }
    async setMode(e) {
    ...
    async removeCurrentMode() {
      for (let e of this.modes) await e.detachedFromContext();
      (this.modes.clear(), await this.update());
    }
    ...
    async dispose() {
      (d.instance().removeListener("cameraProperties", this.cameraPropertiesReportListener),
        ...
        this.pendingWorkerMessageListeners.clear(),
        (this.dataCaptureInstance = void 0),
        (this.delayedRegistration = false),
        (this.highEndBlurryRecognition = false),
    ...
    async getAppName() {
      ...
      if (a$6()) {
        let t = await b();
        if ((t == null ? void 0 : t.appName) == null || t.appName === "")
          throw new Error(
            "Cannot retrieve electron appName. Did you set it up in package.json? https://www.electronjs.org/docs/latest/api/app#appgetname",
          );
        e = t.appName;
      }
      return e;
    ...
    async createContext(e = true) {
      (await this.workerCommand("createContext", {
        ...
        this.subscribeToWorkerMessages(this.onWorkerMessageListener),
        e &&
    ...
    async sendFrameToHandlers(e) {
      for (let t of this._frameHandlers)
        if ((await t(e)).action === "skip") return { skip: true, capture: e };
      return { skip: false, capture: e };
    }
    ...
    unregisterFrameHandler(e) {
      this._frameHandlers.includes(e) &&
        this._frameHandlers.splice(this._frameHandlers.indexOf(e), 1);
    }
    onVisibilityChange() {
    ...
    onWorkerMessage(e) {
      if (e.type === "contextDidChangeStatus") {
        e.payload.isValid || a$8.error(e.payload);
        for (let t of this.listeners)
          t.didChangeStatus && t.didChangeStatus(this, a$9.fromJSON(e.payload));
      }
        ...
        t.didChangeStatus &&
          t.didChangeStatus(
            ...
            a$9.fromJSON({
              ...
              isValid: true,
              message:
                typeof (e == null ? void 0 : e.toString) == "function"
                  ? e.toString()
                  : "Unknown error",
            }),
          );
    }
    async update(e = [], { updateContext: t = true } = {}) {
      var r, s;
      t && (await this.updateContext());
      for (let o of e) {
        switch (o.type) {
          ...
          case "addOverlay": {
            await this.addNativeOverlay(o.newValue);
            break;
          }
          case "removeOverlay": {
            await this.removeNativeOverlay(o.newValue);
            break;
          }
        }
        for (let m of this.updateListeners) m(o);
      }
    }
    async updateContext() {
      await this.workerCommand("updateContext", {
        context: this.toJSONObject(),
        ...this.getViewInfo(),
      }).catch((e) => a$8.warn("Error while updating context:", e));
    }
    getViewInfo() {
    ...
    getMirrorAxisForFrameSource(e) {
      let t = "None";
      return (f(e) && e.getMirrorImageEnabled() && (t = "Y"), t);
    }
    async addComponent(e) {
      if (!this.components.includes(e))
        return (this.components.push(e), (e._context = this), this.update());
    }
    async addNativeOverlay(e) {
      if (F(e))
        return this.workerCommand("addNativeOverlay", {
          overlayHandle: e[a$a],
        });
    }
    async removeNativeOverlay(e) {
      if (F(e))
        return this.workerCommand("removeNativeOverlay", {
          overlayHandle: e[a$a],
        });
    }
    ...
    updateCameraFrameFlow() {
      let e = [...this.modes].some((t) => t._synchronousFrameFlow === true);
...
((a.deviceID = a$1.getDeviceId()),
  (a.moduleLicenseTextProviders = [new a$2()]),
  c([n], a.prototype, "initializeWithOptions", 1),
  c([n], a.prototype, "addMode", 1),
  c([n], a.prototype, "removeMode", 1),
  c([n], a.prototype, "setMode", 1),
  c([n], a.prototype, "removeCurrentMode", 1),
  c([n], a.prototype, "createContext", 1),
  c([n], a.prototype, "addComponent", 1),
  c([n], a.prototype, "addNativeOverlay", 1),
  c([n], a.prototype, "removeNativeOverlay", 1),
  c([n], a.prototype, "isFeatureSupported", 1));
var L = a;
export { L as a };
