var createModule = (() =>
  async function (moduleArg = {}) {
        ...
        (function (b) {
          ...
          function e(k) {
            ...
            function m(u) {
              ...
              k.removeRunDependency(
                "datafile_/Users/mkresic/Code/" +
                  ...
                  "-next/packages" +
                  atob("YmxpbmtpZA==") +
                  "-wasm/dist/lightweight/advanced/Centaurus.data",
              );
            }
            ...
            p.prototype = {
              ...
              send: function () {},
              onload: function () {
                this.finish(this.Vb.subarray(this.start, this.end));
              },
              finish: function (u) {
    ...
    l.onAbort = function (a) {
      da("Aborted with message: " + a);
      try {
        throw new WebAssembly.RuntimeError(a);
      } catch (b) {
        da("Stacktrace: " + b.stack);
      }
    };
    ...
    async function Ea(a) {
      ...
      if (a == Da && ma) a = new Uint8Array(ma);
      else if (ja) a = ja(a);
    ...
    async function Ga(a) {
      var b = Da;
      if (!ma && "function" == typeof WebAssembly.instantiateStreaming)
        try {
          var c = fetch(b, { credentials: "same-origin" });
          return await WebAssembly.instantiateStreaming(c, a);
        } catch (d) {
          (da(`wasm streaming compile failed: ${d}`),
    ...
    var Ia = (a) => {
      ...
      Ya = "undefined" != typeof TextDecoder ? new TextDecoder() : void 0,
      H = (a, b = 0, c = NaN) => {
        var d = b + c;
        for (c = b; a[c] && !(c >= d); ) ++c;
        if (16 < c - b && a.buffer && Ya) return Ya.decode(a.subarray(b, c));
        for (d = ""; b < c; ) {
          var e = a[b++];
          if (e & 128) {
            var f = a[b++] & 63;
    ...
    var eb = {
        ...
        read(a, b, c, d) {
          if (!a.Aa || !a.Aa.Sa.Nb) throw new L(60);
          for (var e = 0, f = 0; f < d; f++) {
            try {
              var g = a.Aa.Sa.Nb(a.Aa);
            } catch (h) {
              throw new L(29);
            }
          ...
          e && (a.node.Ta = Date.now());
          return e;
        },
        write(a, b, c, d) {
          if (!a.Aa || !a.Aa.Sa.zb) throw new L(60);
          try {
            for (var e = 0; e < d; e++) a.Aa.Sa.zb(a.Aa, b[c + e]);
          } catch (f) {
            throw new L(29);
          }
          d && (a.node.Ia = a.node.Ha = Date.now());
          return e;
        },
      },
      fb = {
      ...
      M = {
        ...
        createNode(a, b, c, d) {
          ...
          M.Oa ||
            (M.Oa = {
              ...
              link: {
                node: { Ma: M.xa.Ma, Qa: M.xa.Qa, gb: M.xa.gb },
                stream: {},
              },
              Hb: { node: { Ma: M.xa.Ma, Qa: M.xa.Qa }, stream: jb },
            });
          c = kb(a, b, c, d);
          N(c.mode)
        ...
        xa: {
              ...
              a.Ca != b &&
                (0 == b
                  ...
                  : ((c = a.wa),
                    ...
                    c && a.wa.set(c.subarray(0, Math.min(b, a.Ca))),
                    (a.Ca = b))));
          },
          bb() {
            throw M.Kb;
          ...
          Rb(a, b, c) {
            ...
            if (d) {
              if (N(a.mode)) for (var e in d.wa) throw new L(55);
              mb(d);
            }
            delete a.parent.wa[a.name];
            b.wa[c] = a;
            a.name = c;
            b.Ha = b.Ia = a.parent.Ha = a.parent.Ia = Date.now();
          },
          sb(a, b) {
            delete a.wa[b];
            a.Ha = a.Ia = Date.now();
        ...
        va: {
          ...
          write(a, b, c, d, e, f) {
            ...
            f = e + d;
            var g = a.wa ? a.wa.length : 0;
            g >= f ||
              ((f = Math.max(f, (g * (1048576 > g ? 2 : 1.125)) >>> 0)),
              0 != g && (f = Math.max(f, 256)),
              (g = a.wa),
              (a.wa = new Uint8Array(f)),
              0 < a.Ca && a.wa.set(g.subarray(0, a.Ca), 0));
      ...
      ob = [],
      pb = (a, b, c, d) => {
        "undefined" != typeof Browser && Browser.Ic();
        var e = !1;
        ob.forEach((f) => {
      ...
      Ab = class {
        ...
        constructor(a, b, c, d) {
          ...
          this.mode = c;
          this.fb = d;
          this.Ta = this.Ia = this.Ha = Date.now();
        }
        get read() {
          return (this.mode & this.pb) === this.pb;
        }
        set read(a) {
          a ? (this.mode |= this.pb) : (this.mode &= ~this.pb);
        }
        get write() {
          ...
          if ("." !== a[f])
            if (".." === a[f])
              ...
              try {
                ...
                if (44 === h?.Da && g && b.pc) return { path: e };
                throw h;
              }
              !d.cb || (g && !b.ub) || (d = d.cb.root);
              if (40960 === (d.mode & 61440) && (!g || b.jb)) {
                if (!d.xa.gb) throw new L(52);
                d = d.xa.gb(d);
                "/" === d.charAt(0) || (d = Ua(e) + "/" + d);
    ...
    function lb(a, b) {
      var c = N(a.mode) ? ((c = Eb(a, "x")) ? c : a.xa.bb ? 0 : 2) : 54;
      if (c) throw new L(c);
      for (c = vb[Db(a.id, b)]; c; c = c.Ya) {
        var d = c.name;
    ...
    function Ib(a, b = -1) {
      ...
      if (-1 == b)
        a: {
          for (b = 0; 4096 >= b; b++) if (!tb[b]) break a;
          throw new L(33);
        }
      a.Ua = b;
      return (tb[b] = a);
    ...
    function Lb(a, b) {
      var c = "/" === b;
      if (c && rb) throw new L(10);
      if (!c && b) {
        var d = Bb(b, { ub: !1 });
        b = d.path;
        d = d.node;
        if (d.cb) throw new L(10);
        if (!N(d.mode)) throw new L(54);
      }
      b = { type: a, Kc: {}, Pb: b, nc: [] };
      a = a.Ra(b);
      a.Ra = b;
      b.root = a;
      c ? (rb = a) : d && ((d.cb = b), d.Ra && d.Ra.nc.push(b));
    }
    function Mb(a, b, c) {
      var d = Bb(a, { parent: !0 }).node;
      a = a && a.match(/([^\/]+|\/)\/*$/)[1];
      if (!a) throw new L(28);
      if ("." === a || ".." === a) throw new L(20);
      var e = Gb(d, a);
      if (e) throw new L(e);
      if (!d.xa.nb) throw new L(63);
      return d.xa.nb(d, a, b, c);
    }
    function Nb(a, b = 438) {
    ...
    function Pb(a, b) {
      if (!Xa(a)) throw new L(44);
      var c = Bb(b, { parent: !0 }).node;
      if (!c) throw new L(44);
      b = b && b.match(/([^\/]+|\/)\/*$/)[1];
      var d = Gb(c, b);
      if (d) throw new L(d);
      if (!c.xa.rb) throw new L(63);
      c.xa.rb(c, b, a);
    }
    function Qb(a) {
      var b = Bb(a, { parent: !0 }).node;
      if (!b) throw new L(44);
      a = a && a.match(/([^\/]+|\/)\/*$/)[1];
      var c = lb(b, a);
      a: {
      ...
      if (d) throw new L(d);
      if (!b.xa.sb) throw new L(63);
      if (c.cb) throw new L(10);
      b.xa.sb(b, a);
      mb(c);
    }
    function Rb(a, b) {
    ...
    function Sb(a, b) {
      a = "string" == typeof a ? Bb(a, { jb: !0 }).node : a;
      Kb(a, {
    ...
    function Tb(a, b, c = 438) {
      ...
      if (b & 65536 && !N(d.mode)) throw new L(54);
      if (
        !f &&
        (e = d
          ? 40960 === (d.mode & 61440)
            ? 32
            : N(d.mode) && ("r" !== Fb(b) || b & 576)
              ? 31
              : Eb(d, Fb(b))
          : 44)
      )
      ...
      if (b & 512 && !f) {
        e = d;
        e = "string" == typeof e ? Bb(e, { jb: !0 }).node : e;
        if (N(e.mode)) throw new L(31);
        if (32768 !== (e.mode & 61440)) throw new L(28);
        var g = Eb(e, "w");
        if (g) throw new L(g);
      ...
      f && Sb(d, c & 511);
      !l.logReadFiles || b & 1 || a in yb || (yb[a] = 1);
      return e;
    }
    function Ub(a) {
      if (null === a.Ua) throw new L(8);
      a.vb && (a.vb = null);
      try {
    ...
    function Vb(a, b, c) {
      if (null === a.Ua) throw new L(8);
      if (!a.seekable || !a.va.Na) throw new L(70);
      if (0 != c && 1 != c && 2 != c) throw new L(28);
      a.position = a.va.Na(a, b, c);
      a.yc = [];
    }
    function Wb(a, b, c, d, e, f) {
      ...
      if (N(a.node.mode)) throw new L(31);
      if (!a.va.write) throw new L(28);
      ...
      db(e, {
        ...
        read(f, g, h, n) {
          for (var k = 0, p = 0; p < n; p++) {
            ...
            if (void 0 === m && 0 === k) throw new L(6);
            if (null === m || void 0 === m) break;
            k++;
            g[h + p] = m;
          }
          k && (f.node.Ta = Date.now());
          return k;
        },
        write(f, g, h, n) {
          for (var k = 0; k < n; k++)
          ...
          n && (f.node.Ia = f.node.Ha = Date.now());
          return k;
        },
      });
      return Ob(a, b, e);
    ...
    function ac(a) {
      if (!(a.lc || a.mc || a.link || a.wa)) {
        if ("undefined" != typeof XMLHttpRequest)
          throw Error(
            "Lazy loading should have been performed (contents set) in createLazyFile, but it was not. Lazy loading only works in web workers. Use --embed-file or --preload-file in emcc on the main thread.",
          );
        try {
          ((a.wa = ja(a.url)), (a.Ca = a.wa.length));
        } catch (b) {
          throw new L(29);
        }
      }
    ...
    function ec(a, b) {
      ...
      A[(a + 16) >> 2] = b.dc;
      A[(a + 20) >> 2] = b.fb;
      D[(a + 24) >> 3] = BigInt(b.size);
      A[(a + 32) >> 2] = 4096;
      A[(a + 36) >> 2] = b.Ub;
      var c = b.Ta.getTime(),
        d = b.Ia.getTime(),
        e = b.Ha.getTime();
      D[(a + 40) >> 3] = BigInt(Math.floor(c / 1e3));
      B[(a + 48) >> 2] = (c % 1e3) * 1e6;
      D[(a + 56) >> 3] = BigInt(Math.floor(d / 1e3));
      B[(a + 64) >> 2] = (d % 1e3) * 1e6;
      D[(a + 72) >> 3] = BigInt(Math.floor(e / 1e3));
      B[(a + 80) >> 2] = (e % 1e3) * 1e6;
      D[(a + 88) >> 3] = BigInt(b.fc);
      return 0;
    }
    var Qa = void 0,
      fc = {},
    ...
    var oc = (a, b, c) => {
        switch (b) {
          case 1:
            return c ? (d) => r[d] : (d) => v[d];
          case 2:
            return c ? (d) => y[d >> 1] : (d) => sa[d >> 1];
          case 4:
            return c ? (d) => A[d >> 2] : (d) => B[d >> 2];
          case 8:
            return c ? (d) => D[d >> 3] : (d) => va[d >> 3];
          default:
            throw new TypeError(`invalid integer width (${b}): ${a}`);
        }
      },
      pc = (a) => {
        throw new U(a.ua.Ba.ya.name + " instance already deleted");
      },
      qc = !1,
      rc = () => {},
      sc = (a) => {
        ...
        qc = new FinalizationRegistry((b) => {
          b = b.ua;
          --b.count.value;
          0 === b.count.value && (b.Fa ? b.Ja.Pa(b.Fa) : b.Ba.ya.Pa(b.za));
        });
        sc = (b) => {
          var c = b.ua;
          c.Fa && qc.register(b, { ua: c }, b);
          return b;
        };
        rc = (b) => {
          qc.unregister(b);
    ...
    var vc = (a, b) => Object.defineProperty(b, "name", { value: a }),
      ...
      yc = (a, b, c) => {
        if (l.hasOwnProperty(a)) {
          if (void 0 === c || (void 0 !== l[a].Ea && void 0 !== l[a].Ea[c]))
            throw new U(`Cannot register public name '${a}' twice`);
          xc(l, a, a);
          if (l[a].Ea.hasOwnProperty(c))
            throw new U(
    ...
    function Dc(a, b) {
      if (null === b) {
        if (this.wb) throw new U(`null is not a valid ${this.name}`);
        return 0;
      }
    ...
    var Uc = (a) => {
      ...
      ad = (a, b) => {
        a >>= 1;
        b = a + b / 2;
        for (var c = a; !(c >= b) && sa[c]; ) ++c;
        if (16 < c - a && $c) return $c.decode(sa.subarray(a, c));
        for (c = ""; !(a >= b); ++a) {
          var d = sa[a];
          if (0 == d) break;
    ...
    function Ad(a, b, c, d, e) {
      function f() {
        ...
        Z(a + 16, C);
        Z(a + 24, 0);
        (F = t.response ? t.response.byteLength : 0) && Z(a + 32, F);
        y[(a + 40) >> 1] = t.readyState;
        y[(a + 42) >> 1] = t.status;
        t.statusText && J(t.statusText, v, a + 44, 64);
        K && ((F = Cd(t.responseURL)), (B[(a + 200) >> 2] = F));
      }
      var g = B[(a + 8) >> 2];
      if (g) {
        var h = g ? H(v, g) : "",
        ...
        t.withCredentials = !!v[n + 60];
        t.open(k, h, !K, m, q);
        K || (t.timeout = p);
        t.Mc = h;
        t.responseType = "arraybuffer";
        x && ((h = x ? H(v, x) : ""), t.overrideMimeType(h));
        if (g)
          for (;;) {
            n = B[g >> 2];
            if (!n) break;
        ...
        t.onreadystatechange = (F) => {
          if (Y.has(G)) {
            y[(a + 40) >> 1] = t.readyState;
            2 <= t.readyState && (y[(a + 42) >> 1] = t.status);
            if (!K && 2 === t.readyState && 0 < t.responseURL.length) {
              var C = Cd(t.responseURL);
              B[(a + 200) >> 2] = C;
            }
            e?.(a, t, F);
          }
    ...
    (function () {
      P("/dev");
      db(259, { read: () => 0, write: (d, e, f, g) => g, Na: () => 0 });
      Ob("/dev/null", 259);
      cb(1280, fb);
      cb(1536, gb);
      Ob("/dev/tty", 1280);
    ...
    M.Kb = new L(44);
    M.Kb.stack = "<generic error, no stack>";
    (() => {
      let a = uc.prototype;
      Object.assign(a, {
        isAliasOf: function (c) {
          ...
          c.ua = c.ua;
          var f = c.ua.Ba.ya;
          for (c = c.ua.za; d.Ga; ) ((e = d.hb(e)), (d = d.Ga));
          for (; f.Ga; ) ((c = f.hb(c)), (f = f.Ga));
          return d === f && e === c;
        },
        clone: function () {
          this.ua.za || pc(this);
          if (this.ua.eb) return ((this.ua.count.value += 1), this);
          var c = sc,
            d = Object,
            e = d.create,
        ...
        ["delete"]() {
          ...
          var c = this.ua;
          --c.count.value;
          0 === c.count.value && (c.Fa ? c.Ja.Pa(c.Fa) : c.Ba.ya.Pa(c.za));
          this.ua.eb || ((this.ua.Fa = void 0), (this.ua.za = void 0));
        },
        isDeleted: function () {
          return !this.ua.za;
        },
    ...
    Object.assign(Kc.prototype, {
      ...
      fromWireType: function (a) {
        function b() {
          return this.mb
            ? Jc(this.ya.Xa, { Ba: this.qc, za: c, Ja: this, Fa: a })
            : Jc(this.ya.Xa, { Ba: this, za: a });
        }
        var c = this.ac(a);
        ...
        d = this.lb ? d.Wb : d.pointerType;
        var e = Gc(c, this.ya, d.ya);
        return null === e
          ? b.call(this)
          : this.mb
            ? Jc(d.ya.Xa, { Ba: d, za: e, Ja: this, Fa: a })
            : Jc(d.ya.Xa, { Ba: d, za: e });
      },
    });
    Y = new yd();
    ...
    xa();
    l.noExitRuntime && (Ma = l.noExitRuntime);
    l.preloadPlugins && (ob = l.preloadPlugins);
    l.print && (la = l.print);
    l.printErr && (da = l.printErr);
    l.wasmBinary && (ma = l.wasmBinary);
    l.thisProgram && (ea = l.thisProgram);
    l.addRunDependency = Aa;
    l.removeRunDependency = Ba;
    l.FS_createPreloadedFile = (a, b, c, d, e, f, g, h, n, k) => {
      ...
      var m = b ? Xa(Ta(a + "/" + b)) : a,
        q = `cp ${m}`;
      Aa(q);
      "string" == typeof c ? nb(c).then(p, g) : p(c);
    };
    l.FS_unlink = (...a) => Qb(...a);
    ...
    var Ld = {
          ...
          try {
            ...
            switch (b) {
              ...
              case 3:
                return d.flags;
              case 4:
                return ((e = Ra()), (d.flags |= e), 0);
              case 12:
                return ((e = Ra()), (y[(e + 0) >> 1] = 2), 0);
              case 13:
              case 14:
                return 0;
            }
            ...
            switch (b) {
              ...
              case 21505:
                ...
                if (d.Aa.Sa.ic) {
                  ...
                  A[(e + 8) >> 2] = 191;
                  A[(e + 12) >> 2] = 35387;
                  for (var f = 0; 32 > f; f++) r[e + f + 17] = a[f] || 0;
                }
                return 0;
              case 21510:
              case 21511:
              ...
              case 21531:
                e = Ra();
                if (!d.va.hc) throw new L(59);
                return d.va.hc(d, b, e);
              case 21523:
                if (!d.Aa) return -59;
                d.Aa.Sa.kc &&
                  ((f = [24, 80]),
        ...
        d: (a) => {
          ...
          var c = b.Ab,
            d = b.Pa,
            e = b.Lb,
            f = e.map((g) => g.cc).concat(e.map((g) => g.vc));
          mc([a], f, (g) => {
            var h = {};
            e.forEach((n, k) => {
              var p = g[k],
        ...
        ha: (a, b, c, d, e, f, g, h, n, k, p, m, q) => {
          ...
          mc([a, b, c], d ? [d] : [], (u) => {
            ...
            u = vc(p, function (...t) {
              ...
              if (void 0 === G)
                throw new U(
                  `Tried to invoke ctor of ${p} with invalid number of parameters (${t.length}) - expected (${Object.keys(E.Wa).toString()}) parameters instead!`,
                );
        ...
        ga: (a, b, c, d, e, f) => {
          ...
          mc([], [a], (h) => {
            ...
            void 0 === h.ya.Wa && (h.ya.Wa = []);
            if (void 0 !== h.ya.Wa[b - 1])
              throw new U(
        ...
        p: (a, b, c) => {
          ...
          R(a, {
            name: c,
            fromWireType: (h) => {
              for (var n = B[h >> 2], k, p = h + 4, m = 0; m <= n; ++m) {
                var q = h + 4 + m * b;
                if (m == n || 0 == g(q))
                  ((p = d(p, q - p)),
                    void 0 === k
        ...
        c: (a, b, c, d, e, f) => {
          fc[a] = { name: S(b), Ab: W(c, d), Pa: W(e, f), Lb: [] };
        },
          ...
          return nd(
            vc(b, (g, h, n, k) => {
              for (var p = 0, m = 0; m < a; ++m)
                ((f[m] = d[m].readValueFromPointer(k + p)), (p += d[m].Ka));
        ...
        J: function (a, b, c, d, e, f) {
          ...
          try {
            var g = O(e);
            if (c & 2) {
              if (32768 !== (g.node.mode & 61440)) throw new L(43);
              d & 2 || (g.va.ob && g.va.ob(g, v.slice(a, a + b), f, b, d));
            }
          } catch (h) {
            ...
            a: {
              ...
              for (var f, g = (b = 0); g < c; g++) {
                ...
                var k = e,
                  ...
                  q = f,
                  x = r;
                if (0 > m || 0 > q) throw new L(28);
                if (null === k.Ua) throw new L(8);
                if (1 === (k.flags & 2097155)) throw new L(8);
                if (N(k.node.mode)) throw new L(31);
                if (!k.va.read) throw new L(28);
        ...
        O: function (a, b, c, d) {
          ...
          try {
            ...
            var e = O(a);
            Vb(e, b, c);
            D[d >> 3] = BigInt(e.position);
            e.vb && 0 === b && 0 === c && (e.vb = null);
            return 0;
          } catch (f) {
            if ("undefined" == typeof Q || "ErrnoError" !== f.name) throw f;
            return f.Da;
      ...
      Md = await (async function () {
        ...
        Da ??= l.locateFile
          ? l.locateFile
            ? l.locateFile("Centaurus.wasm", ha)
            : ha + "Centaurus.wasm"
          : new URL("Centaurus.wasm", import.meta.url).href;
        return a((await Ga(b)).instance);
      })();
    function Nd() {
      function a() {
        l.calledRun = !0;
