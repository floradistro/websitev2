...
declare function normalizeLibraryLocation(
  libraryLocation: string,
  pageLocation?: LocationLike,
): string;
...
declare function getLibraryLocationURIs(
  version: string,
  normalizedLibraryLocation: string,
  wasmFileName: string,
): {
  jsURI: string;
  wasmURI: string;
