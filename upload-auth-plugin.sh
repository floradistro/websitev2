...
# Upload Flora Auth Plugin to WordPress

echo "📤 Uploading flora-auth-endpoint.php to WordPress..."

# Copy file content
PLUGIN_CONTENT=$(cat flora-auth-endpoint.php | base64)

# Create plugin via SSH
ssh -p 18765 u2736-pgt6vpiklij1@gvam1142.siteground.biz << 'ENDSSH'
cd ~/public_html/wp-content/plugins
cat > flora-auth-endpoint.php << 'ENDPHP'
<?php
/**
...
ls -la flora-auth-endpoint.php

ENDSSH

echo "✅ Done! Now activate the plugin in WordPress admin"
