-- Fix: Remove vendor_id from stock_movements insert (column doesn't exist)
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Create stock movement record (WITHOUT vendor_id - column doesn't exist)
...
COMMENT ON FUNCTION receive_purchase_order_items IS 'Atomic function to receive purchase order items with proper decimal precision. Handles inventory updates, receiving records, and stock movements in a single transaction.';
