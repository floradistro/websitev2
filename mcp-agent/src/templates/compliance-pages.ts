...
export function generateFAQContent(vendorName: string) {
  return [
    {
...
export function generatePrivacyPolicy(vendorName: string, vendorEmail: string) {
  return {
...
export function generateTermsOfService(vendorName: string) {
  return {
...
export function generateCookiePolicy(vendorName: string) {
  return {
    title: "Cookie Policy",
    last_updated: new Date().toISOString().split('T')[0],
...
export function generateDisclaimers(vendorName: string) {
  return {
...
export const CANNABIS_EDUCATION = {
  first_time_buyers: {
