...
exports.COMPONENT_REGISTRY = {
    smart_components: {
        smart_product_grid: {
            ...
            use_when: 'Vendor has products in database. This component queries products table automatically.',
            example: {
    ...
    sections: {
        hero: {
            ...
            required: true,
            typical_components: ['text (brand name)', 'text (tagline)', 'button (CTA)', 'image (optional)'],
        ...
        featured_products: {
            ...
            best_practices: 'Always include smart_product_grid. Show 6-8 products for optimal conversion.'
        },
        locations: {
        ...
        reviews: {
            ...
            best_practices: 'Builds trust. Include even if vendor has 0 reviews (shows "No reviews yet").'
        },
        about_story: {
        ...
        shipping_badges: {
            ...
            typical_components: ['text (same-day delivery)', 'text (discreet packaging)', 'text (lab tested)'],
    ...
    design_guidelines: {
        cannabis_dispensary: {
            ...
            sections: ['hero', 'process', 'featured_products', 'locations', 'shipping_badges', 'reviews', 'footer']
        },
        restaurant: {
        ...
        retail: {
            ...
            sections: ['hero', 'featured_products', 'shipping_badges', 'reviews', 'about_story', 'footer']
        }
    }
};
exports.AGENT_INSTRUCTIONS = `
