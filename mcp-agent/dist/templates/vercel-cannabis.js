"use strict";
/**
 * Vercel-Style Black & White Cannabis Template
 * Ultra-minimal, monochrome, professional
...
exports.VERCEL_CANNABIS_TEMPLATE = {
    template_id: 'vercel_cannabis_black',
    name: 'Vercel Black - Cannabis',
    description: 'Ultra-minimal monochrome design. Black background, white text, maximum impact.',
    design_system: {
        colors: {
            background: '#000000',
            text_primary: '#ffffff',
