...
async function generateStorefrontWithAgent(vendorId, vendorData) {
    ...
    try {
        ...
        if (useTemplate) {
            ...
            design = (0, template_engine_1.applyTemplate)(enrichedVendorData);
            ...
            const designResponse = await anthropic.messages.create({
                ...
                system: component_registry_1.AGENT_INSTRUCTIONS,
                messages: [{
                        role: 'user',
...
COMPONENT REGISTRY:
${JSON.stringify(component_registry_1.COMPONENT_REGISTRY, null, 2)}
...
async function insertComponentsDirectSQL(vendorId, sectionMap, components) {
    const supabase = getSupabaseClient();
