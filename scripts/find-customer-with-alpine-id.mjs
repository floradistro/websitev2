...
console.log('🔍 Finding customers with real Alpine IQ contact IDs\n');
...
if (!mappings || mappings.length === 0) {
  console.log('⚠️  No customers found with real Alpine IQ contact IDs');
  process.exit(0);
}

console.log(`✅ Found ${mappings.length} customers with Alpine IQ mappings\n`);

// Test each one to see if wallet pass works
for (const mapping of mappings.slice(0, 5)) {
  ...
  try {
    ...
    if (passData.apple || passData.google) {
      ...
      console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('\n🎉 SUCCESS! Found a working customer for wallet testing!');
      console.log('\n📋 Use this customer to test:');
