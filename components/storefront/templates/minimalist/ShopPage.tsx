...
function StorefrontShopClient({ vendorId }: StorefrontShopClientProps) {
  ...
  return (
    <>
      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-px pt-8">
...
export default StorefrontShopClient;
