...
export default async function StorefrontAboutPage({ searchParams }: { searchParams: Promise<{ vendor?: string; preview?: string }> }) {
  ...
  const sections = await getVendorSectionsWithInit(vendor.id, vendor.store_name || vendor.slug, 'about');
