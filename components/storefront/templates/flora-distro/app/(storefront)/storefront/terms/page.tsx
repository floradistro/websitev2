...
export default async function StorefrontTermsPage({ searchParams }: { searchParams: Promise<{ vendor?: string; preview?: string }> }) {
  ...
  const sections = await getVendorSectionsWithInit(vendor.id, vendor.store_name || vendor.slug, 'terms');
