      ...
      const sketch = (p: any) => {
        ...
        p.draw = () => {
          ...
          for (let bubble of bubbles) {
            ...
            // Outer glow layers
            p.noStroke();
            p.fill(255, 255, 255, 2 + pulse * 2);
            p.circle(bubble.x, bubble.y, bubble.size * 2.5);
            
            p.fill(255, 255, 255, 4 + pulse * 4);
            p.circle(bubble.x, bubble.y, bubble.size * 1.8);

            // Main bubble
            p.fill(255, 255, 255, 8 + pulse * 6);
            ...
            p.stroke(255, 255, 255, 25 + pulse * 20);
            p.strokeWeight(1);
            p.arc(
            ...
            for (let j = i + 1; j < bubbles.length; j++) {
              ...
              if (d < 200) {
                ...
                for (let t = 0; t <= 1; t += 0.1) {
                  ...
                  let wave = p.sin(t * p.PI * 3 + time * 2) * 5;
                  p.vertex(x + wave, y);
                }
                p.endShape();
              }
