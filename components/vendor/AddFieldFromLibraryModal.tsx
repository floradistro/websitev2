              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded p-3 mb-4">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {fieldType.properties.map((prop: string) => (
                    <span key={prop} className="text-white/60 text-[10px] bg-white/10 px-2 py-1 rounded">
                      {prop}
                    </span>
                  ))}
                </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setConfig({ ...config, field_id: e.target.value.toLowerCase().replace(/[^a-z0-9_]/g, '_') })}
                  ...
                  />
                  <p className="text-white/40 text-[10px] mt-1">Unique identifier (lowercase, underscores)</p>
                </div>
