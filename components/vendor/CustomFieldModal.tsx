...
const FIELD_TYPES = [
  ...
  { value: 'textarea', label: 'Long Text', description: 'Multi-line paragraph' },
...
export function CustomFieldModal({ isOpen, onClose, onSave, vendorId, categories }: CustomFieldModalProps) {
