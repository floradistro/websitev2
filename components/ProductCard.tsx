      ...
      <div className="relative aspect-[4/5] overflow-hidden bg-[#2a2a2a] md:transition-all md:duration-500">
        ...
        {vendorInfo && (
          <Link
            ...
            className="absolute bottom-2 right-2 z-10 block w-10 h-10 bg-white/5 backdrop-blur-md border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 overflow-hidden group"
