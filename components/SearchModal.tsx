...
export default function SearchModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal Content */}
      <div
        className="absolute inset-0 flex items-start justify-center px-4 overflow-hidden"
        ...
        >
          ...
          {searchQuery.trim().length === 0 && (
            <div className="p-4 sm:p-6 border-t border-white/10">
              <p className="text-xs sm:text-sm uppercase tracking-wider text-white/40 mb-4">
                Quick Links
              </p>
