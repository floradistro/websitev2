...
export default function LuxuryHero() {
  ...
  return (
    <section className="relative h-auto sm:min-h-[100svh] flex items-center justify-center bg-[#1a1a1a] text-white px-4 sm:px-6 overflow-hidden pt-24 pb-20 sm:pt-0 sm:pb-0 w-full max-w-full">
