    ...
    <div className="space-y-2">
      <div className="relative">
        <select
          ...
          className="w-full appearance-none bg-transparent border border-white/20 px-3 py-2.5 pr-7 text-sm font-normal text-white hover:border-white/40 hover:bg-white/5 focus:border-white focus:outline-none transition-all duration-300 cursor-pointer uppercase tracking-[0.1em]"
          style={{
            colorScheme: 'dark'
          }}
        >
