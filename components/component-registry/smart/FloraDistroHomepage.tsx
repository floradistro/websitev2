...
export function FloraDistroHomepage({
  ...
  return (
    <SmartComponentWrapper componentName="FloraDistroHomepage" animate={animate}>
      <>
        {activeState === "Mobile" && (
          <div className="relative min-h-screen bg-black overflow-hidden">
            ...
            <div className="relative flex flex-col items-center justify-center px-4 pt-32 pb-16 text-center">
              <div className="relative z-10">
                ...
                <p className="text-base text-white/80 mb-6 max-w-sm mx-auto">{heroSubheadline}</p>
            ...
            <div className="relative z-10 px-6 py-16">
              ...
              <div className="flex overflow-x-auto gap-6 pb-4 snap-x snap-mandatory scrollbar-hide">
                {products?.slice(0, 8).map((product, i) => (
                  <div key={product.id} className="flex-shrink-0 w-72 snap-center group">
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/50 hover:border-purple-500/50">
                      ...
                      <h3 className="text-white font-black uppercase text-lg mb-2 truncate">
                        {product.name}
                      </h3>
                  ...
                  {trustBadges.map((badge: any, i: number) => (
                    ...
                    >
                      <div className="text-center">
                        ...
                        <h3
                          className="text-white font-black uppercase tracking-tight text-2xl"
            ...
            <div className="relative z-10 px-8 py-24 parallax-products">
              ...
              <div className="max-w-7xl mx-auto grid grid-cols-4 gap-8">
                {products?.slice(0, 8).map((product, i) => (
                  ...
                  >
                    <div
                      className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-500 hover:scale-105 hover:-translate-y-4 relative overflow-hidden"
                      style={{
                        transition: "all 0.5s cubic-bezier(0.4, 0, 0.2, 1)",
                      }}
                      onMouseEnter={(e) => {
                        e.currentTarget.style.boxShadow =
                          "0 30px 80px -15px rgba(139, 92, 246, 0.8), 0 0 60px rgba(16, 185, 129, 0.4)";
