          ...
          <div className="px-4 py-6 space-y-4">
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  {userLocation && locationsWithDistance.length > 0 && (
                    <div className="text-[9px] uppercase tracking-wider text-green-500/60">
                      Nearest First
                    </div>
                  )}
                </div>
            ...
            {showAddToCart && (
              ...
              >
                ...
                >
                  <span
                    className={`transition-all duration-300 ${addedToCart ? "opacity-0" : "opacity-100"}`}
                  >
                    Add to Cart
                  </span>
                  <span
                    className={`absolute inset-0 flex items-center justify-center gap-2 transition-all duration-300 ${addedToCart ? "opacity-100" : "opacity-0"}`}
                  >
          ...
          <div className="max-w-[2000px] mx-auto flex">
            ...
            <div className="w-1/2 px-12 py-12 relative">
              ...
              <div className="relative z-10 space-y-6 max-w-2xl">
                ...
                <div className="">
                  <h1
                    className="text-4xl uppercase tracking-[0.12em] text-white leading-relaxed mb-3"
                ...
                {showAddToCart && (
                  <div className="">
                    <div className="space-y-3">
                      ...
                      >
                        <span
                          className={`inline-flex items-center gap-2 transition-all duration-300 ${addedToCart ? "opacity-0" : "opacity-100"}`}
                        >
                          Add to Cart
                        </span>
                        <span
