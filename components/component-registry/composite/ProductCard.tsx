    ...
    >
      ...
      <div className="flex flex-col flex-1 px-3 sm:px-4 py-3 sm:py-4">
        <div className="space-y-3">
          {/* Product Name */}
          <a href={productUrl}>
            <h3 className="text-base sm:text-xs uppercase tracking-[0.12em] text-white line-clamp-2 leading-relaxed hover:text-white/80 transition-colors" style={{ fontWeight: 900 }}>
              {product.name}
            </h3>
          </a>
