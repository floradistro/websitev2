      ...
      <div className={`bg-[#0a0a0a] border ${borderColors[type]} rounded-2xl p-6 max-w-md w-full`}>
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="flex-1">
            <h3 className="text-xs uppercase tracking-[0.15em] text-white font-black mb-2" style={{ fontWeight: 900 }}>
              {title}
            </h3>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex-1 px-4 py-3 bg-white text-black border-2 border-white rounded-2xl hover:bg-black hover:text-white text-[10px] font-black uppercase tracking-[0.15em] transition-all duration-300"
            style={{ fontWeight: 900 }}
          >
            {confirmText || 'OK'}
          </button>
