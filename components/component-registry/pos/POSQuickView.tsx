      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-black text-white uppercase tracking-tight" style={{ fontWeight: 900 }}>
                Quick View
              </h2>
              {product.vendor && (
            ...
            <div className={product.image_url ? "col-span-9" : "col-span-12"}>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="col-span-2">
                  <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-2" style={{ fontWeight: 900 }}>
                    {product.name}
                  </h3>
                  ...
                  {product.description && (
                    <div className="mb-4">
                      <div className="text-white/40 text-[10px] uppercase tracking-[0.15em] mb-2">Full Description</div>
                ...
                <div>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3 mb-3">
                    <div className="text-white/40 text-[9px] uppercase tracking-wider mb-1">Stock</div>
                    <div className={`text-lg font-black ${
                      product.inventory_quantity > 10 ? 'text-green-400' :
                      product.inventory_quantity > 0 ? 'text-yellow-400' :
                      'text-red-400'
                  ...
                  {/* Base Price */}
                  <div className="bg-white/5 border border-white/10 rounded-xl p-3 mb-3">
                    <div className="text-white/40 text-[9px] uppercase tracking-wider mb-1">Base Price</div>
                  ...
                  {sortedTiers.length > 0 && (
                    <div className="mb-3">
                      <div className="text-white/40 text-[9px] uppercase tracking-wider mb-2">Select Quantity</div>
                      <select
                        value={selectedTier}
                      ...
                      >
                        <option value="custom" className="bg-black text-white">Custom Quantity</option>
                        {sortedTiers.map((tier) => (
                          <option key={tier.break_id} value={tier.break_id} className="bg-black text-white">
                  ...
                  {selectedTier === 'custom' && (
                    <div className="mb-3">
                      <div className="text-white/40 text-[9px] uppercase tracking-wider mb-2">Quantity</div>
                      <input
                        type="number"
                        min="0.01"
                        step="0.01"
          ...
          {product.fields && product.fields.length > 0 && (
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div className="text-white/40 text-[10px] uppercase tracking-[0.15em]">Product Information</div>
              </div>
