    ...
    <div className="h-full w-full bg-black text-white flex flex-col overflow-y-auto overflow-x-hidden">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-5xl w-full">
          ...
          {/* Location Grid - Responsive with dynamic columns */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-h-[60vh] overflow-y-auto px-2">
            {locations.map((location) => (
              ...
              >
                ...
                {/* Info */}
                <div className="mb-4">
                  <div className="text-white font-semibold text-lg tracking-tight mb-1 flex items-center gap-2 flex-wrap">
                    <span className="break-words">{location.name}</span>
                    {location.is_primary && (
                      <span className="text-[9px] px-2 py-0.5 bg-blue-500/20 text-blue-400 rounded-md uppercase tracking-wider font-medium flex-shrink-0">
                        Primary
                      </span>
                    )}
                  </div>
