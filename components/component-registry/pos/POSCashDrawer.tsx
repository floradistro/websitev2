          ...
          {!selectedType ? (
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 bg-${movement.color}-500/10 rounded-xl flex items-center justify-center flex-shrink-0`}>
                        <Icon size={20} className={`text-${movement.color}-400`} />
                      </div>
                      <div className="flex-1">
                        <div className="text-white font-black text-sm uppercase tracking-tight" style={{ fontWeight: 900 }}>
                          {movement.label}
                        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-4">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 bg-${selectedMovement?.color}-500/10 rounded-xl flex items-center justify-center flex-shrink-0`}>
                    {selectedMovement && <selectedMovement.icon size={20} className={`text-${selectedMovement.color}-400`} />}
                  </div>
                  <div>
                    <div className="text-white font-black text-sm uppercase tracking-tight" style={{ fontWeight: 900 }}>
