...
import { 
  ...
  FileText, DollarSign, BarChart3, ChevronLeft, Menu, X, Shield 
} from 'lucide-react';
          ...
          >
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/5 relative z-10">
              <Link href="/admin/dashboard" className="flex items-center gap-3" onClick={() => setMobileMenuOpen(false)}>
                ...
                <div>
                  <div className="text-white text-sm font-medium">FloraDistro</div>
                  <div className="text-red-500/80 text-xs tracking-wide">Admin Portal</div>
                </div>
              </Link>
              <button 
        ...
        >
          ...
          <div className="p-4 mt-8">
            <div className="bg-red-500/10 border border-red-500/20 p-4">
              <h3 className="text-white/80 text-xs uppercase tracking-[0.15em] mb-2">Admin Access</h3>
              <p className="text-white/50 text-xs mb-3 leading-relaxed">
                Full marketplace control and management
              </p>
            </div>
          </div>
        </aside>
