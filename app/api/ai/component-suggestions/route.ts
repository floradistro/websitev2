  ...
  if (componentKey === 'text') {
    if (!currentProps.color || currentProps.color === '#ffffff') {
      suggestions.push({
        ...
        description: 'White text on light backgrounds can be hard to read. Consider using a darker color for better contrast.',
  ...
  if (componentKey === 'button') {
    ...
    if (!currentProps.text || currentProps.text === 'Click me') {
      suggestions.push({
        ...
        proposedProps: { text: pageType === 'home' ? 'Shop Now' : 'Learn More' },
  ...
  if (componentKey === 'smart_product_grid') {
    ...
    if (!currentProps.headline) {
      suggestions.push({
        ...
        proposedProps: { headline: pageType === 'home' ? 'Featured Products' : 'Our Products' },
