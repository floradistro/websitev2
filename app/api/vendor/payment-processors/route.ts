...
export async function POST(request: NextRequest) {
  try {
    ...
    switch (action) {
      ...
      case 'set_default':
        return await setDefaultProcessor(supabase, userData.vendor_id, id, processorData.location_id);
...
async function createProcessor(supabase: any, vendorId: string, userId: string, data: any) {
  ...
  return NextResponse.json({ processor, message: 'Payment processor created successfully' });
}
...
async function updateProcessor(supabase: any, vendorId: string, id: string, data: any) {
  ...
  return NextResponse.json({ processor, message: 'Payment processor updated successfully' });
}
...
async function deleteProcessor(supabase: any, vendorId: string, id: string) {
  ...
  return NextResponse.json({ message: 'Payment processor deleted successfully' });
}
...
async function setDefaultProcessor(
  ...
  return NextResponse.json({ processor: updated, message: 'Default processor updated successfully' });
}
