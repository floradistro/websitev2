    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="pt-24 sm:pt-32 md:pt-40 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Complete REST API for building cannabis commerce platforms. Dispensary operations, inventory management, compliance tracking, wholesale ordering, and more.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl p-6 sm:p-10 md:p-12 lg:p-16 hover:border-white/10 transition-colors duration-500 relative overflow-hidden">
            ...
            <AnimatedGrid className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 relative z-10">
              {[
                { title: "Cannabis POS", desc: "Complete point-of-sale operations" },
                { title: "Inventory", desc: "Multi-location stock management" },
                { title: "Compliance", desc: "Lab results & COA tracking" },
                { title: "Orders", desc: "E-commerce & fulfillment" },
      ...
      <AnimatedSection className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl p-6 sm:p-10 md:p-12 hover:border-white/10 transition-all duration-500 group relative overflow-hidden">
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-black mb-4 sm:mb-6 uppercase tracking-tight relative z-10" style={{ fontWeight: 900 }}>
              186 Endpoints
              <br />
            ...
            <Link
              href="/api-status"
              className="group inline-flex items-center justify-center gap-3 bg-white text-black px-8 py-4 rounded-2xl text-xs uppercase tracking-[0.08em] font-black transition-all hover:scale-105 hover:shadow-[0_0_50px_rgba(255,255,255,0.2)] relative overflow-hidden"
              style={{ fontWeight: 900 }}
            >
              <span className="relative z-10">View API Status</span>
      ...
      <AnimatedSection className="py-12 sm:py-16 md:py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl p-6 sm:p-10 md:p-12 lg:p-16 hover:border-white/10 transition-colors duration-500 group relative overflow-hidden">
            ...
            <p className="text-sm text-white/60 mb-8 sm:mb-12 relative z-10">
              Partnership required for API access
            </p>
            <Link
              href="/vendor/login"
