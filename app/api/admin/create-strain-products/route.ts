...
const STRAIN_DATA: Record<string, any> = {
  "peanut butter breath": {
    ...
    description:
      "A unique hybrid cross of Do-Si-Dos and Mendo Breath. Known for its nutty, earthy flavor profile and deeply relaxing effects.",
  },
  gg4: {
    ...
    description:
      "Also known as Gorilla Glue #4, this award-winning hybrid delivers heavy-handed euphoria and relaxation.",
  },
  "gary payton": {
    type: "hybrid",
    ...
    description:
      "Named after the NBA legend, this Cookies strain is a potent hybrid of The Y and Snowman.",
  },
  "apples and bananas": {
    type: "hybrid",
    ...
    description:
      "A delicious cross bringing together the best of fruity genetics with balanced hybrid effects.",
  },
  "air headz": {
    name: "Air Headz",
    type: "hybrid",
  ...
  "jet fuel": {
    ...
    description:
      "High-octane hybrid known for its diesel aroma and energizing effects. Also called G6.",
  },
  "pez runtz": {
    name: "Pez Runtz",
    type: "hybrid",
    ...
    description:
      "A sweet Runtz phenotype with candy-like flavors reminiscent of the classic Pez candy.",
  },
  "lemon cherry": {
    ...
    description:
      "A flavorful cross combining citrus and cherry notes with balanced hybrid effects.",
  },
  "pink lady": {
  ...
  "super runtz": {
    ...
    flavors: ["Sweet", "Fruity", "Candy"],
    description:
      "An enhanced Runtz selection with intensified sweet candy flavors and potent effects.",
  },
  "purple slurpee": {
    name: "Purple Slurpee",
    type: "indica",
    ...
    description:
      "A purple-hued indica with grape and berry flavors reminiscent of the frozen drink.",
  },
  skittlez: {
    name: "Skittlez",
    type: "hybrid",
  ...
  try {
    ...
    for (const item of unmatchedImages) {
      try {
        ...
        // Find strain data
        const strainKey = Object.keys(STRAIN_DATA).find(
          (key) => nameClean.includes(key) || key.includes(nameClean),
        );

        const strainInfo = strainKey
          ? STRAIN_DATA[strainKey]
          : {
              type: "hybrid",
        ...
        const { data: newProduct, error: createError } = await supabase
          ...
          .insert({
            ...
            regular_price: 35.0, // Default pricing
            manage_stock: true,
