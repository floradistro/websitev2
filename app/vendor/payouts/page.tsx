...
export default function VendorPayouts() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span
        className={`px-3 py-1.5 text-xs font-medium uppercase tracking-wider border ${style.bg} ${style.text} ${style.border} inline-flex items-center gap-1.5`}
      >
        <Icon size={12} />
        {status}
      </span>
  ...
  return (
    <div className="w-full px-4 lg:px-0">
      ...
      {/* Summary Stats */}
      <div
        className="grid grid-cols-1 md:grid-cols-3 gap-3 lg:gap-4 mb-6"
      ...
      {loading ? (
        ...
        <>
          ...
          {/* Desktop Table View */}
          <div
            className="hidden lg:block bg-black border border-white/5 overflow-x-auto"
            style={{ animation: "fadeInUp 0.6s ease-out 0.2s both" }}
          >
      ...
      <div className="mt-6 bg-white/5 lg:border border-t border-b border-white/10 p-4 -mx-4 lg:mx-0">
        <div className="flex gap-3">
          ...
          <div>
            <div className="text-white/80 text-sm font-medium mb-1 uppercase tracking-wider">
              Payout Information
            </div>
