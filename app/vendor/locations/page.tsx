...
export default function LocationsPage() {
  ...
  return (
    <div className="w-full min-h-screen p-8">
      <div className="mb-12">
        <h1 className="text-white/70 text-2xl tracking-tight mb-1 font-light">Locations</h1>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {locations.map((loc) => (
            <div key={loc.id} className="bg-[#0a0a0a] border border-white/[0.04] rounded-3xl p-6">
              ...
              <h3 className="text-white/80 text-lg font-light tracking-tight mb-3">{loc.name}</h3>
                      ...
                      <div className="mt-2 space-y-1">
                        {loc.settings.tax_config.taxes.map((tax, idx) => (
                          <div key={idx} className="flex items-center justify-between pl-3">
                            <span className="text-white/40 text-[10px] font-light">{tax.name}</span>
