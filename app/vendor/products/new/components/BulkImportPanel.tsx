  ...
  return (
    <div className="space-y-4">
      <div className={cn(ds.components.card, "rounded-2xl")}>
        ...
        <p className="text-white/30 text-[9px] mt-1 -mt-3">
          All products in this batch will use this category
        </p>
        ...
        <div className="mt-4">
          <label
            className="block text-white/40 text-[10px] mb-2 font-black uppercase tracking-[0.15em]"
                  ...
                  >
                    ...
                    {img.matchedTo && (
                      <div className="absolute bottom-0 left-0 right-0 bg-green-500/20 border-t border-green-500/40 p-1">
                        <div
                          className="text-green-400 text-[8px] font-black uppercase tracking-wider truncate"
                          style={{ fontWeight: 900 }}
                        >
                          {img.matchedTo}
                        </div>
            ...
            <div className="mb-4">
              ...
              <p className="text-white/30 text-[8px] mt-2">
                {selectedFields.size === 0
                  ...
                  : `${selectedFields.size} fields selected for ${bulkInput.split("\n").filter((l) => l.trim()).length} products`}
              </p>
            </div>
          ...
          <div className={cn(ds.colors.bg.primary, "mt-4 border border-white/10 rounded-xl p-4")}>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  onClick={() =>
                    onCurrentReviewIndexChange(
                      Math.min(bulkProducts.length - 1, currentReviewIndex + 1),
                    )
                  }
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-white/40 text-[9px]">
                        $
                      </span>
                      <input
                        type="number"
                        ...
                        className={cn(
                          ds.components.card,
                          "w-full rounded-xl text-white pl-6 pr-3 py-2 text-[10px]",
                        )}
                      />
                    </div>
                  </div>
            ...
            <div className="mt-4 flex items-center gap-2">
              <button
                ...
                className={cn(
                  ds.components.card,
                  "flex-1 px-4 py-2 text-white/60 rounded-xl text-[9px] uppercase tracking-[0.15em] font-black hover:text-white hover:border-white/20 transition-all disabled:opacity-30",
                )}
                style={{ fontWeight: 900 }}
              >
                Cancel
