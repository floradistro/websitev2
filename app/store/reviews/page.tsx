    ...
    <div className="w-full px-4 lg:px-0">
      ...
      <div className="mb-6 -mx-4 lg:mx-0" style={{ animation: "fadeInUp 0.6s ease-out 0.2s both" }}>
        <div className="relative px-4 lg:px-0">
          <Search
            size={18}
            className="absolute left-7 lg:left-3 top-1/2 -translate-y-1/2 text-white/40"
          />
          <input
            type="text"
      ...
      {/* Reviews List */}
      <div
        className="space-y-0 lg:space-y-4 -mx-4 lg:mx-0"
        style={{ animation: "fadeInUp 0.6s ease-out 0.3s both" }}
      >
        {filteredReviews.map((review) => (
          <div
            key={review.id}
            className="bg-black lg:border border-t lg:border-t border-white/5 lg:hover:border-white/10 transition-all"
          >
            {/* Review Header */}
