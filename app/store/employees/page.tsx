  ...
  return (
    <div className="w-full min-h-screen p-8">
      <div className="mb-12 flex items-center justify-between">
        <div>
          <h1 className="text-white/70 text-2xl tracking-tight mb-1 font-light">Team</h1>
          <p className="text-white/25 text-[11px] uppercase tracking-[0.2em] font-light">
            {employees.length} {employees.length === 1 ? "Employee" : "Employees"}
          </p>
        </div>
        <button onClick={handleAddEmployee} className={cn(buttonStyles.base, buttonStyles.primary)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {employees.map((emp) => (
            ...
            >
              ...
              {emp.employee_id && (
                <div className="text-white/30 text-[10px] mb-4 font-mono">#{emp.employee_id}</div>
              )}

              <div className="space-y-2 mb-4">
                <div className="flex items-center gap-2">
                  <Mail size={12} className="text-white/30" strokeWidth={1.5} />
                  <span className="text-white/40 text-[11px] font-light truncate">{emp.email}</span>
                </div>
                {emp.phone && (
                  <div className="flex items-center gap-2">
                    <Phone size={12} className="text-white/30" strokeWidth={1.5} />
                    <span className="text-white/40 text-[11px] font-light">{emp.phone}</span>
                  </div>
                )}
              </div>
              ...
              <div className="flex items-center gap-2 pt-4 border-t border-white/[0.04] opacity-0 group-hover:opacity-100 transition-opacity">
                <button
                  ...
                  className={cn(buttonStyles.base, buttonStyles.ghost, "flex-1 text-[10px] py-2")}
                  title="Edit employee"
                >
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#0a0a0a] border border-white/[0.08] rounded-3xl p-8 max-w-md w-full">
        <h2 className="text-white/80 text-xl font-light tracking-tight mb-2">Set Password</h2>
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-[#0a0a0a] border border-white/[0.08] rounded-3xl p-8 max-w-lg w-full">
        <h2 className="text-white/80 text-xl font-light tracking-tight mb-2">Assign Locations</h2>
        <p className="text-white/40 text-sm mb-6">
          {employee.first_name} {employee.last_name}
        </p>
