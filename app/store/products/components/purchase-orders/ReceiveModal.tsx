...
const CONDITION_OPTIONS = [
  {
    value: "good",
    label: "Good",
    description: "Product in perfect condition",
    color: "text-green-400",
  },
  {
    value: "damaged",
    label: "Damaged",
    description: "Packaging or product damaged",
    color: "text-yellow-400",
  },
  {
    value: "expired",
    label: "Expired",
    description: "Product past expiration",
    color: "text-orange-400",
  },
  {
    value: "rejected",
    label: "Rejected",
    description: "Product rejected/not accepted",
    color: "text-red-400",
  },
];
