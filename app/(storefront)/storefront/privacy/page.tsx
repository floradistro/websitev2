...
export default async function StorefrontPrivacyPage({ searchParams }: { searchParams: Promise<{ vendor?: string; preview?: string }> }) {
  ...
  const sections = await getVendorSectionsWithInit(vendor.id, vendor.store_name || vendor.slug, 'privacy');
