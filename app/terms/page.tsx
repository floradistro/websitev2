        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12 text-white/60 leading-relaxed">
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p>
                By accessing and using WhaleTools ("Service"), you accept and
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p>
                WhaleTools provides a multi-tenant commerce platform that
                enables partners to create, manage, and operate unlimited
                e-commerce storefronts. The Service includes but is not limited
                to:
              </p>
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p>
                ...
                functionality are owned by WhaleTools and are protected by
                international copyright, trademark, patent, trade secret, and
                other intellectual property laws.
              </p>
              <p className="mt-4">
                You retain all rights to content you upload to the Service. By
                uploading content, you grant us a worldwide, non-exclusive
                license to use, host, and display that content for the purpose
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <div className="space-y-4">
                ...
                <p className="mt-4">
                  In the event we fail to meet our uptime guarantee, you may be
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p>
                ...
                industry-standard security measures. You are responsible for
                ensuring your use of the Service complies with applicable data
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p className="mt-4">
                ...
                Upon termination, we will provide you with an export of your
                data within 30 days.
              </p>
            </div>
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p>
                To the maximum extent permitted by law, WhaleTools shall not be
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p>
                You agree to indemnify and hold harmless WhaleTools, its
