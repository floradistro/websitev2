        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12 text-white/60 leading-relaxed">
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p>
                WhaleTools provides a multi-tenant commerce platform that enables partners to create, 
                manage, and operate unlimited e-commerce storefronts. The Service includes but is not 
                limited to:
              </p>
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <div className="space-y-4">
                ...
                <p className="mt-4">
                  In the event we fail to meet our uptime guarantee, you may be eligible for 
                  service credits as outlined in our SLA documentation.
                </p>
              </div>
            </div>
            ...
            <div className="border-l-2 border-white/10 pl-6">
              ...
              <p className="mt-4">
                ...
                we will provide you with an export of your data within 30 days.
              </p>
            </div>

            {/* Section 10 */}
            <div className="border-l-2 border-white/10 pl-6">
              <h2 className="text-2xl font-light text-white/90 mb-4">10. Limitation of Liability</h2>
              <p>
